...
import GoalVisionBox from "@/components/GoalVisionBox";
...
const sustainability = {
  ...
  content:
    "Fundamentals to our sustainability goals is to focus on being a value-added solutions provider, maintaining excellence in the health and safety of our employees and affected stakeholders, in the safety and quality of our work, and in our efforts to protect and preserve the environment to provide energy industry solutions. ISI remains focused on implementing robust, reliable, safe, and environmentally responsible practices and solutions throughout the global energy industry sectors.",
};
  ...
  if (variant === "home") {
   ...
   return (
    <section className="relative overflow-hidden bg-white">
      ...
      {/* Video Background + Paragraph + 3 Boxes */}
      <div className="relative min-h-[600px] bg-dark sm:min-h-[700px] md:min-h-[800px] lg:min-h-[900px]">
        <VideoBackground
          src="https://videos.pexels.com/video-files/37151630/15738797_1920_1080_30fps.mp4"
          poster="/images/gas4.webp"
          className="video-bg"
