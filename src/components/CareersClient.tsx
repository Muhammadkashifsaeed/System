          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-12">
            <div className="lg:col-span-5">
              <AnimatedSection delay={0}>
                ...
                <p className="mt-6 text-base leading-[1.8] text-[#475569] md:text-lg">
                  ...
                  <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                    <div>
                      ...
                      <input
                        ...
                        className="h-[52px] w-full rounded-xl border border-gray-200 bg-white px-4 text-sm text-[#0F172A] placeholder:text-gray-400 outline-none transition-all duration-300 hover:border-gray-300 focus:border-primary focus:shadow-[0_0_0_4px_rgba(15,76,129,0.1)]"
                      />
                    </div>
                    ...
                    <div>
                      <label htmlFor="location" className="mb-2 block text-sm font-medium text-[#0F172A]">
                        Your Location
                      </label>
                      <input
                        id="location"
                    ...
                    <div>
                      <label htmlFor="position" className="mb-2 block text-sm font-medium text-[#0F172A]">
                    ...
                    <div>
                      <label htmlFor="yearsInIndustry" className="mb-2 block text-sm font-medium text-[#0F172A]">
                        Years In Industry
                      </label>
                      <input
                        id="yearsInIndustry"
                    ...
                    <div>
                      <label htmlFor="yearsInCurrentPosition" className="mb-2 block text-sm font-medium text-[#0F172A]">
                    ...
                    <div>
                      <label htmlFor="cv" className="mb-2 block text-sm font-medium text-[#0F172A]">
                        Attach CV
                      </label>
                      <input
                        id="cv"
                        ...
                        required
                        accept=".pdf,.doc,.docx"
                        className="h-[52px] w-full rounded-xl border border-gray-200 bg-white px-4 text-sm text-[#0F172A] outline-none transition-all duration-300 hover:border-gray-300 focus:border-primary focus:shadow-[0_0_0_4px_rgba(15,76,129,0.1)]"
                      />
                    </div>
                    ...
                    <div className="md:col-span-2">
                      ...
                      <textarea
                        ...
                        className="w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm text-[#0F172A] placeholder:text-gray-400 outline-none transition-all duration-300 hover:border-gray-300 focus:border-primary focus:shadow-[0_0_0_4px_rgba(15,76,129,0.1)]"
                      />
                    </div>
