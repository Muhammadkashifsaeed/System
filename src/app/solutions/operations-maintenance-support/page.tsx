  ...
  return (
    <div className="flex flex-col">
      <PageHero
        ...
        backgroundImage="https://images.pexels.com/photos/9477545/pexels-photo-9477545.jpeg"
      ...
      <section className="bg-white section-padding">
        <div className="container-custom">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 items-start">
            <div>
              <h2 className="text-3xl font-bold text-black md:text-4xl">OPERATIONS AND MAINTENANCE SUPPORT (O&M)</h2>
